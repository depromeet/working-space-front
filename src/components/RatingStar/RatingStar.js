  ...
  return (
    <RatingStarStyled simple={isSimpleMode}>
      <div className="rating_area">
        <ReactStars count={starCount} value={Number(rating)} edit={isStarEditable} size={starSize} color={starColor} activeColor={starActiveColor} isHalf={isStarHalf} onChange={onRatingChanged} />
      </div>
